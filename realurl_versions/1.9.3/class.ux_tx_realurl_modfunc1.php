	...
	function redirectView()	{
		...
		if (is_array($list))	{
			...
			foreach($list as $rec)	{
				...
				if(empty($rec['hidden'])) {
					$hideUnhideButton = '<a href="#" onclick="jumpToUrl(\'../../../tce_db.php?&amp;data[tx_realurl_redirects]['.$rec['uid'].'][hidden]=1&amp;redirect=%2Ftypo3%2Fmod%2Fweb%2Finfo%2Findex.php%3Fid%3D1&amp;vC=55a5ca1449&amp;prErr=1&amp;uPT=1\');return false;">
								<img'.t3lib_iconWorks::skinImg($this->pObj->doc->backPath,'gfx/button_hide.gif','width="16" height="16"').' title="Hide entry" alt="" />
							</a>';
				} else {
					$hideUnhideButton = '<a href="#" onclick="jumpToUrl(\'../../../tce_db.php?&amp;data[tx_realurl_redirects]['.$rec['uid'].'][hidden]=0&amp;redirect=%2Ftypo3%2Fmod%2Fweb%2Finfo%2Findex.php%3Fid%3D1&amp;vC=55a5ca1449&amp;prErr=1&amp;uPT=1\');return false;">
				...
				$tCells[] = '<td>'.
							...
							'.$hideUnhideButton.'
							<a href="#" onclick="
							if(confirm(String.fromCharCode(68,105,101,115,101,110,32,68,97,116,101,110,115,97,116,122,32,116,97,116,115,228,99,104,108,105,99,104,32,108,246,115,99,104,101,110,63))){
								jumpToUrl(\'../../../tce_db.php?redirect=%2Ftypo3%2Fmod%2Fweb%2Finfo%2Findex.php%3Fid%3D1&amp;cmd[tx_realurl_redirects]['.$rec['uid'].'][delete]=1\');
								};return false;"><img'.t3lib_iconWorks::skinImg($this->pObj->doc->backPath,'gfx/garbage.gif','width="16" height="16"').' title="Delete entry" alt="" /></a>'.
						'</td>';
				$tCells[]='<td>'.$rec['counter'].'</td>';
